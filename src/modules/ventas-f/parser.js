// src/modules/ventas-f/parser.js
 ...
 * ["", "Kilos","Litros","C","Factor F","Teorico K","Teorico L","% Real","F Real K","F Real L","Dif K","Dif L"]
 * El primer header vacío se mapea a "concepto".
 * Adicionalmente exponemos id, parentId y level detectados del treeTable (clases "child-of-node-...").
 */
function parseVentasF(html) {
